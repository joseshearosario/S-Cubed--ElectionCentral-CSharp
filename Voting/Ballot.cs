...
namespace Voting
{
    class Ballot
    {
        ...
        public void vote ()
        {
            foreach (Election e in elections)
            {
                ...
                do
                {
                    valid = false;
                    e.printBallot();
                    Console.Write("Using the number associated with the candidate, who do you vote for? ");
        ...
        public void addCandidate (String position, String fN, String mN, String lN, string pP)
        {
            if (search(position))
            {
                foreach (Election e in elections)
